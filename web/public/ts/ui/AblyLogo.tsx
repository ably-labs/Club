...
const AblyLogo = (): React.ReactElement => {
    return <>
        <a href="https://ably.com" className={"hover:opacity-20 pl-2"}>
            <svg className="hover:opacity-50 inline-block" width="108" height="32"
                ...
                <defs>
                    <linearGradient id="paint0_linear" x1="5.47361" y1="37.4219" x2="32.4603" y2="7.45023"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5416"></stop>
                        <stop offset="0.2535" stopColor="#FF5115"></stop>
                        <stop offset="0.461" stopColor="#FF4712"></stop>
                        <stop offset="0.6523" stopColor="#FF350E"></stop>
                        <stop offset="0.8327" stopColor="#FF1E08"></stop>
                        <stop offset="1" stopColor="#FF0000"></stop>
                    </linearGradient>
                    <linearGradient id="paint1_linear" x1="10.7084" y1="39.3593" x2="26.6583" y2="21.6452"
                                    gradientUnits="userSpaceOnUse">
                        <stop stopColor="#FF5416"></stop>
                        <stop offset="0.2535" stopColor="#FF5115"></stop>
                        <stop offset="0.461" stopColor="#FF4712"></stop>
