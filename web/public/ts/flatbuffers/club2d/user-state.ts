...
export class UserState {
    ...
    static createFaceMeshVector(builder: flatbuffers.Builder, data: number[] | Int8Array | Uint8Array): flatbuffers.Offset {
    ...
    static createFaceMeshColorVector(builder: flatbuffers.Builder, data: number[] | Int8Array | Uint8Array): flatbuffers.Offset {
        builder.startVector(1, data.length, 1);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addInt8(data[i]!);
        }
    ...
    static createUserState(builder: flatbuffers.Builder, faceMeshOffset: flatbuffers.Offset, faceMeshColorOffset: flatbuffers.Offset, faceMeshSize: number): flatbuffers.Offset {
